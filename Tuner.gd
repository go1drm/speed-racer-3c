...
const GRAPPLE_PARAMS := [
	...
	["__group", "检测区域可视化 (L 键切换)"],
	["detect_zone_visible",          "检测区域默认显示",          0, 1, 1,
		"1=启动时就显示检测区域; 0=默认隐藏(按 L 键运行时切换). 推荐 0.", ""],
	["detect_zone_alpha",            "检测区域透明度",            0.0, 1.0, 0.01,
		"检测区域球体的透明度. 0=完全透明, 1=完全不透明. 推荐 0.08~0.2, 太高遮挡视线.", ""],
	["detect_zone_segments",         "检测区域球体细分",          8, 64, 4,
		"检测区域球体的细分段数. 越大越圆滑. 16 足够.", ""],
	["detect_cone_visible",          "瞄准锥体显示",             0, 1, 1,
		"1=同时显示瞄准锥角(从车头方向延伸的锥形); 0=只显示球体不显示锥体.", ""],
	["detect_cone_alpha",            "瞄准锥体透明度",           0.0, 1.0, 0.01,
		"瞄准锥体的透明度. 推荐 0.04~0.1.", ""],
]
