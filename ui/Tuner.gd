...
const FREE_GRAPPLE_PARAMS := [
	...
	["anchor_offset.y",       "锚点Y偏移(上)",         0.0, 20.0, 0.5,
		"锚点上方偏移.", ""],
	["anchor_offset.z",       "锚点前方基础距离",      5.0, 60.0, 1.0,
		"实际距离 = 此值 + 水平车速×速度系数.", ""],
	["anchor_speed_scale",    "前方速度系数",           0.0, 3.0, 0.05,
		"每1m/s水平速度额外前移.", ""],
	["anchor_height_speed_scale","高度水平速度系数",    0.0, 1.0, 0.02,
		"每1m/s水平速度额外升高.", ""],
	["anchor_height_upspeed_scale","高度向上速度系数",  0.0, 2.0, 0.05,
		"每1m/s向上速度额外升高.", ""],

	["__group", "➡️ 直线-收绳"],
	["rope_taut_delay",        "射出时间(秒)",          0.2, 2.0, 0.02,
		"射出动画时长.", ""],
	["reel_speed",             "收绳速度(米/秒)",       5.0, 80.0, 1.0,
		"每秒缩短多少米.", ""],
	["pull_force",             "拉力(N×mass)",          30.0, 500.0, 5.0,
		"朝锚点的拉力.", ""],
	...
	["fling_speed_mult",       "甩出速度倍率",          1.0, 3.0, 0.05,
		"绳断时速度×倍率.", ""],
	["fling_min_speed",        "甩出保底速度(m/s)",     5.0, 40.0, 1.0,
		"保底.", ""],

	["__group", "➡️ 直线-空中"],
	["fall_gravity_mult",      "空中重力倍率",          0.1, 5.0, 0.05,
		"<1滞空, 1正常, >1加速落.", ""],
	["air_drag",               "空中阻力",              0.0, 2.0, 0.02,
		"空气阻力.", ""],
	["air_turn_speed",         "转向速度(rad/s)",       0.5, 8.0, 0.1,
		"方向键转车头.", ""],
	...
	["launch_speed",           "发射速度(m/s)",         10.0, 80.0, 1.0,
		"沿车头方向发射.", ""],
	["launch_float_time",      "无重力时间(秒)",        0.0, 1.5, 0.05,
		"发射后短暂无重力.", ""],
	["launch_duration",        "持续时间(秒)",          0.1, 2.0, 0.05,
		"之后回落.", ""],
	...
	["__group", "🔄 过弯-收绳"],
	["swing_ignore_wall",      "穿墙(无视墙碰撞)",     0, 1, 1,
		"过弯钩索挂住后车体穿过墙体. 1=穿墙, 0=正常碰撞.", ""],
	["swing_rope_taut_delay",  "射出时间(秒)",          0.1, 1.5, 0.02,
		"过弯射出动画时长.", ""],
	["swing_reel_speed",       "收绳速度(米/秒)",       5.0, 80.0, 1.0,
		"过弯收绳速度.", ""],
	["swing_pull_force",       "拉力(N×mass)",          30.0, 500.0, 5.0,
		"过弯拉力.", ""],
	...
	["swing_torque",           "扭矩修正(rad/s²)",      0.0, 15.0, 0.5,
		"车头自动转向切线方向.", ""],
	["release_on_steer_up",   "松手断绳",               0, 1, 1,
		"松开方向键时断绳.", ""],
	["steer_release_grace",   "松手容错(秒)",           0.0, 0.3, 0.02,
		"松手延迟容错.", ""],

	["__group", "🔄 过弯-甩出"],
	["swing_fling_speed_mult", "甩出速度倍率",          1.0, 3.0, 0.05,
		"过弯甩出速度倍率.", ""],
	["swing_fling_min_speed",  "甩出保底速度(m/s)",     5.0, 40.0, 1.0,
		"过弯甩出保底.", ""],

	["__group", "🔄 过弯-空中"],
	["swing_fall_gravity_mult","空中重力倍率",           0.1, 5.0, 0.05,
		"过弯后空中重力.", ""],
	["swing_air_drag",         "空中阻力",              0.0, 2.0, 0.02,
		"过弯后空气阻力.", ""],
	["swing_air_turn_speed",   "转向速度(rad/s)",       0.5, 8.0, 0.1,
		"过弯后空中转向.", ""],
	["swing_air_drift_turn_mult","漂移键转向倍率",      1.0, 5.0, 0.1,
		"过弯后漂移键加速转向.", ""],

	["__group", "🔄 过弯-发射"],
	["swing_launch_speed",     "发射速度(m/s)",         10.0, 80.0, 1.0,
		"过弯后发射速度.", ""],
	["swing_launch_float_time","无重力时间(秒)",         0.0, 1.5, 0.05,
		"过弯后发射无重力.", ""],
	["swing_launch_duration",  "持续时间(秒)",          0.1, 2.0, 0.05,
		"过弯后发射持续时间.", ""],
